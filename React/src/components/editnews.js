...
export default function EditNews(props){
    ...
    function changeOption(e){
        ...
        return fetch(`http://localhost:26303/api/News/${e.target.value}`)
    ...
    function onCreateNews(){
        ...
        fetch(`http://localhost:26303/api/News/${newsId}`,{
        method: 'PUT',
        ...
        <div id="id01" className="modal">
            ...
            <form className="modal-content"onSubmit={onCreateNews}>
                <div className="newscontainer">
                    <h1>Add News</h1>
                    <hr/>
                    <label><b>Select News Heading</b></label><br/>
                    <div className="editselect">
                        <select type="text" placeholder="Enter Heading" 
                        name ='id' onChange={changeOption} value={news.id}>
                            <option disabled selected value> -- select a news -- </option>
                             {props.list.map((news) => (
